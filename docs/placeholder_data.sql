...
('1F1F15W86HEF45678', 2018, 'Ford', 'F-150', 'Lariat', 42995, 39800, 'Ingot Silver', 'Gray', 'Pickup Truck', '10-Speed Automatic', '4WD', 'Gasoline', '3.5L V6', 'V6', '3.5L', 375, 19, 25, 1, 1, 'DEN234567', 'Used', '2018 Ford F-150 Lariat - Loaded with options. Spray-in bedliner, tonneau cover, remote start.', '["Lariat Package", "Leather Interior", "Bang & Olufsen Audio", "Remote Start"]', '["https://example.com/f1-2.jpg", "https://example.com/f2-2.jpg"]', 91, true),
...
('1C4RJFBG1KW345678', 2015, 'Jeep', 'Cherokee', 'Sport', 19995, 71800, 'Bright White', 'Black', 'SUV', '9-Speed Automatic', '4WD', 'Gasoline', '2.4L I4', 'I4', '2.4L', 184, 21, 28, 1, 2, 'AUR567890', 'Used', '2015 Jeep Cherokee Sport - Base model but well-equipped. Needs some TLC.', '["Sport Package", "Uconnect", "Bluetooth", "SiriusXM"]', '["https://example.com/ch2-1.jpg"]', 50, true),
...
('JN1AZ1CP1KC234567', 2020, 'Nissan', 'Pathfinder', 'SL', 34995, 36700, 'Pearl White', 'Charcoal', 'SUV', 'CVT', 'FWD', 'Gasoline', '3.5L V6', 'V6', '3.5L', 284, 20, 27, 1, 3, 'LAK789012', 'Used', '2020 Nissan Pathfinder SL - Family hauler with 3rd row. Clean CarFax.', '["SL Premium Package", "NissanConnect", "Bose Audio", "Heated Seats"]', '["https://example.com/path1.jpg", "https://example.com/path2.jpg"]', 88, true),
('1F1F15W75KEF23456', 2014, 'Ford', 'F-150', 'Platinum', 32995, 94500, 'Ruby Red', 'Ebony', 'Pickup Truck', '6-Speed Automatic', '4WD', 'Gasoline', '3.5L V6', 'V6', '3.5L', 365, 17, 23, 1, 3, 'LAK890123', 'Used', '2014 Ford F-150 Platinum - High miles but excellent condition. Platinum trim has all options.', '["Platinum Package", "Leather", "Sunroof", "Sony Audio"]', '["https://example.com/f5-1.jpg"]', 78, true),
...
-- Normalize duplicate stock numbers per dealer before enforcing unique index
WITH ranked_stocks AS (
    SELECT
        id,
        dealer_id,
        stock_number,
        ROW_NUMBER() OVER (PARTITION BY dealer_id, stock_number ORDER BY id) AS rn
    FROM vehicles
    WHERE stock_number IS NOT NULL
)
UPDATE vehicles v
SET stock_number = v.stock_number || '-' || v.id
